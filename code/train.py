...
parser.add_argument('-ep', '--max_epoch', type=int, default=600)
...
from utils.loss import DC_and_CE_loss, SoftDiceLoss, RobustCrossEntropyLoss
from data.transforms import RandomCrop, CenterCrop, RandomRotFlip, ToTensor, Resize, RandomFlip_UD, RandomFlip_LR, RandomNoise
from data.data_loaders import KneeMRI, KneeMRI_light
from utils import config
import torch.nn as nn

print(config.n_filters)
    ...
    for epoch_num in range(args.max_epoch + 1):
        ...
        if epoch_num % 10 == 0:
            ...
            for batch in eval_loader:
                ...
                # print("eval",image.max(), image.min())

                # img_save = image[0][0].cpu().numpy()*255.0
                # img_save = sitk.GetImageFromArray(img_save)
                # sitk.WriteImage(img_save, '/home/xmli/hnwang/CLD_Semi/vis_test/org_img.nii.gz')
